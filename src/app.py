...
fields[ features[-3] ] = [st.radio( features[-3], ("Máxima, mais alta", "Mediana", "Mínima, mais baixa"))]

fields[ features[-2] ] = [st.radio( features[-2],
                                  ("Sim","Não") )]

fields[features[-1]] = [st.slider("Qual o tamanho do seu calçado?", 25, 50, 35)]
